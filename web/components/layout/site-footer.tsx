    ...
    <footer className="site-footer">
      <div className="page-shell site-footer__top">
        ...
        <div className="site-footer__links">
          <div><span>Explore</span><Link href="/product">Product</Link><Link href={FEATURED_RUN_HREF}>Verified report</Link><Link href="/runs/demo">Demo report</Link><Link href="/methods">Methods</Link></div>
